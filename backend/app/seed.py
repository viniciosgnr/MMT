...
def seed_data():
    ...
    try:
        ...
        # 5.1 Calibration Results (M2) - Needed for M7 Export and FC Guard
        res_list = [
        ...
        # 17. M11 - Specialized Configurations
        print("Seeding Specialized Configurations (M11)...")
        wells = [
